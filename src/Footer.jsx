    ...
    <div id="footer">
      <div id="footer-content">
        <div id="footer-main">
          <div className="footer-item">
            ...
            <p>
              ...
              facere iusto fuga porro ut quos.
            </p>
          </div>
          ...
          <div className="footer-item">
            ...
            <ul>
              ...
              <li onClick={() => (window.location.href = "#best-Sellers")}>
                Bestsellers
              </li>
              <li onClick={() => (window.location.href = "#testimonials")}>
                Reviews
              </li>
              <li onClick={() => (window.location.href = "#booking")}>
                Booking
              </li>
            </ul>
          </div>
        ...
        <div id="footer-bottom">
          <span>
            Food Factory @ 2022 - Made with <BsFillHeartFill fill="red" /> by{" "}
            <span
              onClick={() =>
