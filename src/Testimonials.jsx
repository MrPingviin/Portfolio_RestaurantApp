    ...
    <div id="testimonials" className="page">
      <div id="testimonials-container">
        <div id="testimonials-titles">
          ...
          <h2>
            What People Say <span className="highlighted">About</span>
          </h2>
        </div>
            ...
            <div className="testimonials-review-card">
              ...
              <div className="testimonials-review-card-description">
                ...
                <div className="testimonials-review-card-description-main">
                  <p>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Accusamus nam eveniet nemo atque modi.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="testimonials-review-card">
              ...
              <div className="testimonials-review-card-description">
                ...
                <div className="testimonials-review-card-description-main">
                  <p>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Accusamus nam eveniet nemo atque modi quas sapiente fugiat
                    dicta. Voluptatum, quae!
                  </p>
                </div>
              </div>
            </div>
